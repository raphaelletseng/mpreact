...
function Projects (){
  return (
    <section id = "projects">
      <div class = "sec-title"> <Typewriter class = "type"
        options = {{
      ...
      <div class = "graphic-container">
        <a href="https://raphaelletseng.github.io/datallite-site/#home">
          <img src={Datallite} alt="Datallite" class = "image"/></a>
          <div class = "overlay">
      ...
      <div class = "graphic-container">
        ...
        <img src={McgillAi} alt ="mcgillai" class="image"/></a>
          <div class = "overlay">
      ...
      <div class = "graphic-container">
        <a href="https://github.com/cclin130/know_your_company">
          <img src={Kyc} alt ="Know Your Company" class="image"/></a>
          <div class = "overlay">
      ...
      <div class = "graphic-container">
        <a href="https://mcgillailearn.com">
          <img src={McgillAiLearn} alt ="McGill AI Learn" class="image"/></a>
          <div class = "overlay">
