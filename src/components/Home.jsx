...
function Home() {
  return (
    <div id="home">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 158 1440 120"><path fill="#054a7f" fill-opacity="1" d="M0,256L48,261.3C96,267,192,277,288,272C384,267,480,245,576,229.3C672,213,768,203,864,192C960,181,1056,171,1152,165.3C1248,160,1344,160,1392,160L1440,160L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>

      <Projects/>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 20 1440 110"><path fill="#ed8f65" fill-opacity="1" d="M0,128L60,122.7C120,117,240,107,360,85.3C480,64,600,32,720,32C840,32,960,64,1080,85.3C1200,107,1320,117,1380,122.7L1440,128L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>
      </div>
      <Footer/>
    </div>
